// ignore_for_file: camel_case_types, unnecessary_new, deprecated_member_use, prefer_const_constructors, dead_code, avoid_unnecessary_containers, prefer_const_literals_to_create_immutables, unused_local_variable
...
class ethical_hacking extends StatefulWidget {
  const ethical_hacking({Key? key}) : super(key: key);

  @override
  _ethical_hackingState createState() => _ethical_hackingState();
}
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      "For the first time in college, team CSI conducted a workshop on Ethical Hacking. The workshop witnessed a total of 66 students including 16 CSI members registered Students enthusiastically participating in this workshop. The increased sophistication and success rate for recent cyber attacks is directly related to the shift in attackers profile.",
                      style: TextStyle(
                        height: 1.3,
                        letterSpacing: 1.5,
                        fontSize: 18,
