...
class vacanza extends StatefulWidget {
  const vacanza({Key? key}) : super(key: key);

  @override
  _vacanzaState createState() => _vacanzaState();
}

class _vacanzaState extends State<vacanza> {
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage('assets/images/vacanza.png'),
                  fit: BoxFit.fill,
                ),
              ),
              child: Column(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      "Team CSI conducted an event named VACANZA, this event took place during holidays and witnessed a massive participation. It was a fun and interesting event for students to get reenergized and enjoy during holidays and due to positive response , it came out to be a successful one.",
                      style: TextStyle(
                        height: 1.3,
                        letterSpacing: 1.5,
                        fontSize: 18,
