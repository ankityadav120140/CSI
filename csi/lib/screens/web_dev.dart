...
class web_dev extends StatefulWidget {
  const web_dev({Key? key}) : super(key: key);
...
class _web_devState extends State<web_dev> {
  ...
  Widget build(BuildContext context) {
    ...
    var aIndex = 0;
    final wsImages = [
      'assets/images/workshops/web1.jpg',
      'assets/images/workshops/web2.jpg',
      'assets/images/workshops/web3.jpg',
      'assets/images/workshops/web4.jpg',
    ];
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        "To Introduce the students with the world of Web Designing and Web Development, Team CSI conducted a workshop on Web Technology from 4th Feb to 18th Feb, 2016 (4-6PM) at IT labs. In this workshop students learned about the popular web designing languages HTML, CSS and PHP.",
                        style: TextStyle(
                          height: 1.3,
                          letterSpacing: 1.5,
                          fontSize: 18,
